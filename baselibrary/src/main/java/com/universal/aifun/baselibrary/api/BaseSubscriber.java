package com.universal.aifun.baselibrary.api;
...
import com.universal.aifun.baselibrary.common.ErrorCodeConstants;
import com.universal.aifun.baselibrary.common.VariableConfig;
import com.universal.aifun.baselibrary.help.MySPUtilsUser;
import com.universal.aifun.baselibrary.ui.dialog.CustomProgressDialog;
import com.universal.aifun.baselibrary.utils.LogUtils;
import com.universal.aifun.baselibrary.utils.NetworkUtils;
...
//                PublicPracticalMethodFromJAVA.getInstance().intentToJump((Activity) mContext, LoginActivity.class, Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK, null, true, R.anim.activity_xhold, R.anim.activity_xhold);
                ToastUtils.showShortToastFromRes(R.string.token_is_error, ToastUtils.bottom);
                return;
            }
