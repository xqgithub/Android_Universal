package com.universal.aifun.baselibrary.help;


import com.universal.aifun.baselibrary.common.SPConstants;
import com.universal.aifun.baselibrary.utils.SPUtils;
...
public class MySPUtilsUser {
    ...
    public int getUserLoginMethod() {
        return sputils_user.getInt(SPConstants.USER_LOGINMETHOD, 0);
    }
